...
public abstract class Categoria {
    protected final Hashtable<String,Integer> MASCOTAS;
    ...
    //CONSTRUCTOR
    public Categoria(String[] mascotas){
        MASCOTAS = new Hashtable<>(); //Una tabla de mascotas <String> con su respectivo identificador <Integer>
        for(int i=0; i<mascotas.length; i++){
            MASCOTAS.put(mascotas[i],i); //Se inicializan las mascotas por defecto
        }
    ...
    //OPERACIONES BÁSICAS
    public boolean agregar_producto(int categoria, Producto nuevo){
        ...
        nuevo.identificador(categoria,mascota,desplazamiento); //Asigna al producto un identificador
    ...
    public boolean eliminar_producto(Id identificador){
        try{
            ...
            while(desplazamiento < tabla_de_cantidades.get(mascota) - 1){
            ...
            JOptionPane.showMessageDialog(null,"XD","Error",JOptionPane.ERROR_MESSAGE);
