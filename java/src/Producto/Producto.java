...
public abstract class Producto implements Comparable{
    ...
    public Producto (String categoria, String mascota, String nombre, double precio, double descuento,
        ...
        this.nombre = nombre;
        this.precio = Double.parseDouble(decimalFormat.format(precio));
        this.descuento = Double.parseDouble(decimalFormat.format(descuento));
        this.stock = stock;
    ...
    //METODOS ESTABLECER
    public void identificador(int especie, int indice){
        identificador = new Id(especie,indice);
    }
