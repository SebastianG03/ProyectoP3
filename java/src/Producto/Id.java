...
public class Id {
    ...
    //CONSTRUCTORES
    public Id(int categoria, int mascota, int desplazamiento){
    ...
    public Id(String identificador) throws Exception{
        ...
        if(digitos.length==4){ //Controla que la ID del producto cuente con solo 4 dígitos
            //Se asigna el segundo dígito de la ID como el índice de la especie
    ...
    private String generar_identificador(){
        ...
        String identificador = String.format("%s%s",this.mascota,porcionDesplazamiento);
